...
//  HeadsUpper
//
//  Created by Henna Ahmed on 2/21/16.
...
- (void)viewDidLoad {
    ...
    [self.navigationController.navigationBar setBarTintColor:FlatWatermelon];
    ...
    //http://api.search.live.net/json.aspx?AppId=YOUR_APPID&Query=xbox%20site:microsoft.com&Sources=Image&Version=2.0&Market=en-us&Adult=Moderate&Image.Count=10&Image.Offset=0
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    ...
    return self.topics.allKeys.count;
}
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    ...
    NSString *key = self.topics.allKeys[indexPath.row];
    
    ViewController *vc = segue.destinationViewController;
    vc.answers = [self.topics objectForKey:key];
}
